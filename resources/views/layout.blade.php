					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +8801756517233</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> rabbimahmud95@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								@else
								<li><a href="{{URL::to('/login_customer')}}"><i class="fa fa-shopping-cart"></i>Checkout</a></li>
								...
								@if($customer_id!=NULL)
								<li>
									<a href="{{URL::to('/logout_customer')}}"><i class="fa fa-lock"></i> Logout</a
								</li>
								@else
								<li>
									<a href="{{URL::to('/login_customer')}}"><i class="fa fa-lock"></i> Login</a
								</li>
								@endif
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{URL::to('/login_customer')}}">Checkout</a></li> 
										<li><a href="{{URL::to('/show_cart_items')}}">Cart</a></li> 
						...
						@foreach($categories as $category)
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/products_by_category/'.$category->id)}}">{{$category->category_name}}</a></h4>
								</div>
							</div>
						@endforeach
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/products_by_manufacture/'.$manufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$manufacture->manufacture_name}}</a></li>
									@endforeach
